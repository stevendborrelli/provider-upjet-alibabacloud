...
type ServersInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ecs/v1alpha1.Instance
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("private_ip",false)
	ServerIP *string `json:"serverIp,omitempty" tf:"server_ip,omitempty"`

	// Reference to a Instance in ecs to populate serverIp.
	// +kubebuilder:validation:Optional
	ServerIPRef *v1.NamespacedReference `json:"serverIpRef,omitempty" tf:"-"`

	// Selector for a Instance in ecs to populate serverIp.
	// +kubebuilder:validation:Optional
	ServerIPSelector *v1.NamespacedSelector `json:"serverIpSelector,omitempty" tf:"-"`
