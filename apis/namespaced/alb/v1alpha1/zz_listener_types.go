...
type ListenerInitParameters struct {
	...
	// The SLB Instance Id.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alb/v1alpha1.LoadBalancer
	...
	// Security Policy
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alb/v1alpha1.SecurityPolicy
...
type ServerGroupTuplesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alb/v1alpha1.ServerGroup
	...
	// +kubebuilder:validation:Optional
	ServerGroupIDRef *v1.NamespacedReference `json:"serverGroupIdRef,omitempty" tf:"-"`

	// Selector for a ServerGroup in alb to populate serverGroupId.
	// +kubebuilder:validation:Optional
	ServerGroupIDSelector *v1.NamespacedSelector `json:"serverGroupIdSelector,omitempty" tf:"-"`
}
