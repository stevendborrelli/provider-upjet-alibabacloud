...
type ExecutionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/oos/v1alpha1.Template
	...
	TemplateNameRef *v1.NamespacedReference `json:"templateNameRef,omitempty" tf:"-"`

	// Selector for a Template in oos to populate templateName.
	// +kubebuilder:validation:Optional
	TemplateNameSelector *v1.NamespacedSelector `json:"templateNameSelector,omitempty" tf:"-"`
