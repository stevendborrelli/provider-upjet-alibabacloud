...
type DefaultPatchBaselineInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/oos/v1alpha1.PatchBaseline
	...
	PatchBaselineNameRef *v1.NamespacedReference `json:"patchBaselineNameRef,omitempty" tf:"-"`

	// Selector for a PatchBaseline in oos to populate patchBaselineName.
	// +kubebuilder:validation:Optional
	PatchBaselineNameSelector *v1.NamespacedSelector `json:"patchBaselineNameSelector,omitempty" tf:"-"`
}
