...
type LoadBalancerInitParameters struct {
	...
	MasterZoneIDRef *v1.NamespacedReference `json:"masterZoneIdRef,omitempty" tf:"-"`

	// Selector for a Vswitch in vpc to populate masterZoneId.
	// +kubebuilder:validation:Optional
	MasterZoneIDSelector *v1.NamespacedSelector `json:"masterZoneIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SlaveZoneIDRef *v1.NamespacedReference `json:"slaveZoneIdRef,omitempty" tf:"-"`

	// Selector for a Vswitch in vpc to populate slaveZoneId.
	// +kubebuilder:validation:Optional
	SlaveZoneIDSelector *v1.NamespacedSelector `json:"slaveZoneIdSelector,omitempty" tf:"-"`
