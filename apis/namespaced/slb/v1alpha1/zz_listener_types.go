...
type ListenerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/slb/v1alpha1.ACL
	// +listType=set
	ACLIds []*string `json:"aclIds,omitempty" tf:"acl_ids,omitempty"`

	// References to ACL in slb to populate aclIds.
	// +kubebuilder:validation:Optional
	ACLIdsRefs []v1.NamespacedReference `json:"aclIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ACL in slb to populate aclIds.
	// +kubebuilder:validation:Optional
	ACLIdsSelector *v1.NamespacedSelector `json:"aclIdsSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/slb/v1alpha1.LoadBalancer
