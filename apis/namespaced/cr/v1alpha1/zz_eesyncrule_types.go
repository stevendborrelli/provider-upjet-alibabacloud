...
type EeSyncRuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	TargetInstanceIDRef *v1.NamespacedReference `json:"targetInstanceIdRef,omitempty" tf:"-"`

	// Selector for a EeInstance in cr to populate targetInstanceId.
	// +kubebuilder:validation:Optional
	TargetInstanceIDSelector *v1.NamespacedSelector `json:"targetInstanceIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TargetNamespaceNameRef *v1.NamespacedReference `json:"targetNamespaceNameRef,omitempty" tf:"-"`

	// Selector for a EeNamespace in cr to populate targetNamespaceName.
	// +kubebuilder:validation:Optional
	TargetNamespaceNameSelector *v1.NamespacedSelector `json:"targetNamespaceNameSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TargetRepoNameRef *v1.NamespacedReference `json:"targetRepoNameRef,omitempty" tf:"-"`

	// Selector for a EeRepo in cr to populate targetRepoName.
	// +kubebuilder:validation:Optional
	TargetRepoNameSelector *v1.NamespacedSelector `json:"targetRepoNameSelector,omitempty" tf:"-"`
