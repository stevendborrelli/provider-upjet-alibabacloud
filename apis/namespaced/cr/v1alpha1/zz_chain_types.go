...
type ChainInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/cr/v1alpha1.EeRepo
	...
	// +kubebuilder:validation:Optional
	RepoNameRef *v1.NamespacedReference `json:"repoNameRef,omitempty" tf:"-"`

	// Selector for a EeRepo in cr to populate repoName.
	// +kubebuilder:validation:Optional
	RepoNameSelector *v1.NamespacedSelector `json:"repoNameSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	RepoNamespaceNameRef *v1.NamespacedReference `json:"repoNamespaceNameRef,omitempty" tf:"-"`

	// Selector for a EeNamespace in cr to populate repoNamespaceName.
	// +kubebuilder:validation:Optional
	RepoNamespaceNameSelector *v1.NamespacedSelector `json:"repoNamespaceNameSelector,omitempty" tf:"-"`
}
