...
type CodeInitParameters struct {
	...
	ChecksumSecretRef *v1.LocalSecretKeySelector `json:"checksumSecretRef,omitempty" tf:"-"`
	...
	OssBucketNameRef *v1.NamespacedReference `json:"ossBucketNameRef,omitempty" tf:"-"`

	// Selector for a Bucket in oss to populate ossBucketName.
	// +kubebuilder:validation:Optional
	OssBucketNameSelector *v1.NamespacedSelector `json:"ossBucketNameSelector,omitempty" tf:"-"`

	// The name of the OSS Object that stores the function code ZIP package.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/oss/v1alpha1.BucketObject
	...
	// +kubebuilder:validation:Optional
	OssObjectNameRef *v1.NamespacedReference `json:"ossObjectNameRef,omitempty" tf:"-"`

	// Selector for a BucketObject in oss to populate ossObjectName.
	// +kubebuilder:validation:Optional
	OssObjectNameSelector *v1.NamespacedSelector `json:"ossObjectNameSelector,omitempty" tf:"-"`
...
type FunctionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	LayerRefs []v1.NamespacedReference `json:"layerRefs,omitempty" tf:"-"`

	// Selector for a list of LayerVersion in fcv3 to populate layers.
	// +kubebuilder:validation:Optional
	LayerSelector *v1.NamespacedSelector `json:"layerSelector,omitempty" tf:"-"`

	// The list of layers.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/fcv3/v1alpha1.LayerVersion
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ram/v1alpha1.Role
...
type VPCConfigInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	VSwitchIDRefs []v1.NamespacedReference `json:"vSwitchIdRefs,omitempty" tf:"-"`
