...
type TriggerInitParameters struct {
	...
	// Function Name
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/fcv3/v1alpha1.Function
	...
	// +kubebuilder:validation:Optional
	InvocationRoleRef *v1.NamespacedReference `json:"invocationRoleRef,omitempty" tf:"-"`

	// Selector for a Role in ram to populate invocationRole.
	// +kubebuilder:validation:Optional
	InvocationRoleSelector *v1.NamespacedSelector `json:"invocationRoleSelector,omitempty" tf:"-"`
