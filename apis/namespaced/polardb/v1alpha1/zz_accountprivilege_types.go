...
type AccountPrivilegeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/polardb/v1alpha1.Account
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/polardb/v1alpha1.Database
	...
	// +kubebuilder:validation:Optional
	DBNamesRefs []v1.NamespacedReference `json:"dbNamesRefs,omitempty" tf:"-"`

	// Selector for a list of Database in polardb to populate dbNames.
	// +kubebuilder:validation:Optional
	DBNamesSelector *v1.NamespacedSelector `json:"dbNamesSelector,omitempty" tf:"-"`
}
