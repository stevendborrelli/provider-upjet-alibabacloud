...
type EndpointAddressInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/polardb/v1alpha1.Endpoint
	...
	// +kubebuilder:validation:Optional
	DBEndpointIDRef *v1.NamespacedReference `json:"dbEndpointIdRef,omitempty" tf:"-"`

	// Selector for a Endpoint in polardb to populate dbEndpointId.
	// +kubebuilder:validation:Optional
	DBEndpointIDSelector *v1.NamespacedSelector `json:"dbEndpointIdSelector,omitempty" tf:"-"`
