...
type MonitorConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alidns/v1alpha1.AddressPool
	...
	// +kubebuilder:validation:Optional
	AddrPoolIDRef *v1.NamespacedReference `json:"addrPoolIdRef,omitempty" tf:"-"`

	// Selector for a AddressPool in alidns to populate addrPoolId.
	// +kubebuilder:validation:Optional
	AddrPoolIDSelector *v1.NamespacedSelector `json:"addrPoolIdSelector,omitempty" tf:"-"`
