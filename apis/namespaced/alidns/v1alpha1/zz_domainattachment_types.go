...
type DomainAttachmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alidns/v1alpha1.Domain
	...
	DomainNamesRefs []v1.NamespacedReference `json:"domainNamesRefs,omitempty" tf:"-"`

	// Selector for a list of Domain in alidns to populate domainNames.
	// +kubebuilder:validation:Optional
	DomainNamesSelector *v1.NamespacedSelector `json:"domainNamesSelector,omitempty" tf:"-"`

	// The id of the DNS instance.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alidns/v1alpha1.Instance
