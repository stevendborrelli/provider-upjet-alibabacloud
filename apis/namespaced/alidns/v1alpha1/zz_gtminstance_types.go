...
type GtmInstanceInitParameters struct {
	...
	// The alert group.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/cloudmonitorservice/v1alpha1.AlarmContactGroup
	...
	// +kubebuilder:validation:Optional
	AlertGroupRefs []v1.NamespacedReference `json:"alertGroupRefs,omitempty" tf:"-"`

	// Selector for a list of AlarmContactGroup in cloudmonitorservice to populate alertGroup.
	// +kubebuilder:validation:Optional
	AlertGroupSelector *v1.NamespacedSelector `json:"alertGroupSelector,omitempty" tf:"-"`
