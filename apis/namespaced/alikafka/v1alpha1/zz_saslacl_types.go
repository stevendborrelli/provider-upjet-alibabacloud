...
type SaslACLInitParameters struct {
	...
	// The resource name.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alikafka/v1alpha1.Topic
	...
	ACLResourceNameRef *v1.NamespacedReference `json:"aclResourceNameRef,omitempty" tf:"-"`

	// Selector for a Topic in alikafka to populate aclResourceName.
	// +kubebuilder:validation:Optional
	ACLResourceNameSelector *v1.NamespacedSelector `json:"aclResourceNameSelector,omitempty" tf:"-"`
	...
	// The user name.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/alikafka/v1alpha1.SaslUser
