...
type SubscriptionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	StsRoleArnRef *v1.NamespacedReference `json:"stsRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in ram to populate stsRoleArn.
	// +kubebuilder:validation:Optional
	StsRoleArnSelector *v1.NamespacedSelector `json:"stsRoleArnSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/messageservice/v1alpha1.Topic
