...
type EndpointAclInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/messageservice/v1alpha1.Endpoint
	...
	EndpointTypeRef *v1.NamespacedReference `json:"endpointTypeRef,omitempty" tf:"-"`

	// Selector for a Endpoint in messageservice to populate endpointType.
	// +kubebuilder:validation:Optional
	EndpointTypeSelector *v1.NamespacedSelector `json:"endpointTypeSelector,omitempty" tf:"-"`
}
