...
type KubernetesPermissionsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ram/v1alpha1.User
	UID *string `json:"uid,omitempty" tf:"uid,omitempty"`

	// Reference to a User in ram to populate uid.
	// +kubebuilder:validation:Optional
	UIDRef *v1.NamespacedReference `json:"uidRef,omitempty" tf:"-"`

	// Selector for a User in ram to populate uid.
	// +kubebuilder:validation:Optional
	UIDSelector *v1.NamespacedSelector `json:"uidSelector,omitempty" tf:"-"`
}
...
type PermissionsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	RoleIDRefs *v1.NamespacedReference `json:"roleIdRefs,omitempty" tf:"-"`
