...
type KubernetesNodePoolInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ack/v1alpha1.ManagedKubernetes
	...
	// +kubebuilder:validation:Optional
	ClusterIDRefs *v1.NamespacedReference `json:"clusterIdRefs,omitempty" tf:"-"`
	...
	KMSEncryptedPasswordSecretRef *v1.LocalSecretKeySelector `json:"kmsEncryptedPasswordSecretRef,omitempty" tf:"-"`
...
type UpgradePolicyInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	KubernetesVersionRef *v1.NamespacedReference `json:"kubernetesVersionRef,omitempty" tf:"-"`

	// Selector for a ManagedKubernetes in ack to populate kubernetesVersion.
	// +kubebuilder:validation:Optional
	KubernetesVersionSelector *v1.NamespacedSelector `json:"kubernetesVersionSelector,omitempty" tf:"-"`
