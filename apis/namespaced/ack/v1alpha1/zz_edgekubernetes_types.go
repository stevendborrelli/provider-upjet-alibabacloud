...
type EdgeKubernetesInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	WorkerVswitchIDsRefs []v1.NamespacedReference `json:"workerVswitchIDsRefs,omitempty" tf:"-"`

	// Selector for a list of Vswitch in vpc to populate workerVswitchIds.
	// +kubebuilder:validation:Optional
	WorkerVswitchIDsSelector *v1.NamespacedSelector `json:"workerVswitchIDsSelector,omitempty" tf:"-"`
