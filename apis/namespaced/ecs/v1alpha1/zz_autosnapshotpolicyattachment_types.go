...
type AutoSnapshotPolicyAttachmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ecs/v1alpha1.AutoSnapshotPolicy
	...
	AutoSnapshotPolicyIDRef *v1.NamespacedReference `json:"autoSnapshotPolicyIdRef,omitempty" tf:"-"`

	// Selector for a AutoSnapshotPolicy in ecs to populate autoSnapshotPolicyId.
	// +kubebuilder:validation:Optional
	AutoSnapshotPolicyIDSelector *v1.NamespacedSelector `json:"autoSnapshotPolicyIdSelector,omitempty" tf:"-"`

	// The ID of the disk.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ecs/v1alpha1.Disk
