...
type ImageCopyInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceImageIDRef *v1.NamespacedReference `json:"sourceImageIdRef,omitempty" tf:"-"`

	// Selector for a Image in ecs to populate sourceImageId.
	// +kubebuilder:validation:Optional
	SourceImageIDSelector *v1.NamespacedSelector `json:"sourceImageIdSelector,omitempty" tf:"-"`
