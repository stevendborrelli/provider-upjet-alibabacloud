...
type LaunchTemplateInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ecs/v1alpha1.DeploymentSet
	...
	// +kubebuilder:validation:Optional
	DeploymentSetIDRef *v1.NamespacedReference `json:"deploymentSetIdRef,omitempty" tf:"-"`

	// Selector for a DeploymentSet in ecs to populate deploymentSetId.
	// +kubebuilder:validation:Optional
	DeploymentSetIDSelector *v1.NamespacedSelector `json:"deploymentSetIdSelector,omitempty" tf:"-"`
