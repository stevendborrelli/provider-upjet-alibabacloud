...
type InvocationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/ecs/v1alpha1.Command
	...
	CommandIDRef *v1.NamespacedReference `json:"commandIdRef,omitempty" tf:"-"`

	// Selector for a Command in ecs to populate commandId.
	// +kubebuilder:validation:Optional
	CommandIDSelector *v1.NamespacedSelector `json:"commandIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	InstanceIDRefs []v1.NamespacedReference `json:"instanceIdRefs,omitempty" tf:"-"`
