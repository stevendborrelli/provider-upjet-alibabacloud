...
type ImageImportDiskDeviceMappingInitParameters struct {
	...
	OssBucketRef *v1.NamespacedReference `json:"ossBucketRef,omitempty" tf:"-"`

	// Selector for a Bucket in oss to populate ossBucket.
	// +kubebuilder:validation:Optional
	OssBucketSelector *v1.NamespacedSelector `json:"ossBucketSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	OssObjectRef *v1.NamespacedReference `json:"ossObjectRef,omitempty" tf:"-"`

	// Selector for a BucketObject in oss to populate ossObject.
	// +kubebuilder:validation:Optional
	OssObjectSelector *v1.NamespacedSelector `json:"ossObjectSelector,omitempty" tf:"-"`
}
