...
type SecretInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/namespaced/kms/v1alpha1.Instance
	...
	DkmsInstanceIDRef *v1.NamespacedReference `json:"dkmsInstanceIdRef,omitempty" tf:"-"`

	// Selector for a Instance in kms to populate dkmsInstanceId.
	// +kubebuilder:validation:Optional
	DkmsInstanceIDSelector *v1.NamespacedSelector `json:"dkmsInstanceIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	EncryptionKeyIDRef *v1.NamespacedReference `json:"encryptionKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate encryptionKeyId.
	// +kubebuilder:validation:Optional
	EncryptionKeyIDSelector *v1.NamespacedSelector `json:"encryptionKeyIdSelector,omitempty" tf:"-"`
	...
	SecretDataSecretRef v1.LocalSecretKeySelector `json:"secretDataSecretRef" tf:"-"`
