...
type ListenerInitParameters struct {
	...
	// The SLB Instance Id.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/cluster/alb/v1alpha1.LoadBalancer
	...
	// Security Policy
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/cluster/alb/v1alpha1.SecurityPolicy
...
type ServerGroupTuplesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-alibabacloud/apis/cluster/alb/v1alpha1.ServerGroup
