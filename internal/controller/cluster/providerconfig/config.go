...
import (
	...
	"github.com/crossplane-contrib/provider-alibabacloud/apis/cluster/v1beta1"
)
...
// for their current usage, deferring the setup until the CRDs it depends on
// are established. This is what gives the provider the SafeStart capability.
