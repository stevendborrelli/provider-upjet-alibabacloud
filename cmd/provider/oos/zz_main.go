...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_oos(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud oos controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_oos(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud oos controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_oos(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud oos controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_oos(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud oos controllers")
	}
