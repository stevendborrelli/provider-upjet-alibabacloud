...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_cloudmonitorservice(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud cloudmonitorservice controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_cloudmonitorservice(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud cloudmonitorservice controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_cloudmonitorservice(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud cloudmonitorservice controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_cloudmonitorservice(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud cloudmonitorservice controllers")
	}
