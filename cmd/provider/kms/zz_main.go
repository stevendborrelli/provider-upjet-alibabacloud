...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_kms(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud kms controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_kms(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud kms controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_kms(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud kms controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_kms(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud kms controllers")
	}
