...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_privatelink(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud privatelink controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_privatelink(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud privatelink controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_privatelink(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud privatelink controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_privatelink(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud privatelink controllers")
	}
