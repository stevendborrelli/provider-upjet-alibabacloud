...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_alikafka(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alikafka controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_alikafka(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alikafka controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_alikafka(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alikafka controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_alikafka(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alikafka controllers")
	}
