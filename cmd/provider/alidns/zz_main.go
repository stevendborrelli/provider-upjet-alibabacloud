...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_alidns(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alidns controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_alidns(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alidns controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_alidns(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alidns controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_alidns(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alidns controllers")
	}
