...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_vpc(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud vpc controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_vpc(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud vpc controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_vpc(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud vpc controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_vpc(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud vpc controllers")
	}
