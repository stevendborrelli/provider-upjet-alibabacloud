...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_messageservice(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud messageservice controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_messageservice(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud messageservice controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_messageservice(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud messageservice controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_messageservice(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud messageservice controllers")
	}
