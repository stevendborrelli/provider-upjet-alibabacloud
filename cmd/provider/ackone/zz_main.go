...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ackone(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ackone controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ackone(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ackone controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ackone(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ackone controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ackone(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ackone controllers")
	}
