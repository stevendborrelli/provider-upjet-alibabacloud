...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_polardb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud polardb controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_polardb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud polardb controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_polardb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud polardb controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_polardb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud polardb controllers")
	}
