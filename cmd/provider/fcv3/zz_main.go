...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_fcv3(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud fcv3 controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_fcv3(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud fcv3 controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_fcv3(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud fcv3 controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_fcv3(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud fcv3 controllers")
	}
