...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_tair(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud tair controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_tair(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud tair controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_tair(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud tair controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_tair(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud tair controllers")
	}
