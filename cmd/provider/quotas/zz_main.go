...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_quotas(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud quotas controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_quotas(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud quotas controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_quotas(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud quotas controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_quotas(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud quotas controllers")
	}
