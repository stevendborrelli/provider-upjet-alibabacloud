...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_alb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alb controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_alb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alb controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_alb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud alb controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_alb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud alb controllers")
	}
