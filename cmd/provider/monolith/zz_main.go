...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_monolith(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud monolith controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_monolith(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud monolith controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_monolith(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud monolith controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_monolith(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud monolith controllers")
	}
