...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_oss(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud oss controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_oss(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud oss controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_oss(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud oss controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_oss(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud oss controllers")
	}
