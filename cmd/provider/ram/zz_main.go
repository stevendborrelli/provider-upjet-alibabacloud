...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ram(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ram controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ram(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ram controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ram(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ram controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ram(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ram controllers")
	}
