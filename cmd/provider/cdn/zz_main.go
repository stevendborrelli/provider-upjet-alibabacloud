...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_cdn(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud cdn controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_cdn(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud cdn controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_cdn(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud cdn controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_cdn(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud cdn controllers")
	}
