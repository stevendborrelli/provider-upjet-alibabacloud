...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ecs(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ecs controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ecs(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ecs controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ecs(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud ecs controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ecs(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud ecs controllers")
	}
