...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_slb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud slb controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_slb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud slb controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_slb(mgr, clusterOpts), "Cannot setup cluster-scoped AlibabaCloud slb controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_slb(mgr, namespacedOpts), "Cannot setup namespaced AlibabaCloud slb controllers")
	}
